    ...
    <div className="max-w-3xl mx-auto p-6 space-y-6 mt-10">
      ...
      <div className="space-y-4">
        ...
        <ul className="list-disc list-inside text-gray-600">
          <li>Email: <a href="mailto:help.easemyshoot@gmail.com" className="text-[#6901b1]">help.easemyshoot@gmail.com</a></li>
          <li>Phone: +91-9549800020</li>
          <li>Address: First Floor, 63 B RK Puram, Pratap Nagar, Jaipur, Rajasthan - 302033</li>
